...
import 'security_pop_up_model.dart';
...
class _SecurityPopUpWidgetState extends State<SecurityPopUpWidget> {
  late SecurityPopUpModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SecurityPopUpModel());
  }
